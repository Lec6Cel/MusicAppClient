...
const SongCard = ({data, index}) => {
  return <motion.div className='relative w-40 min-w-210 px-2 py-4 cursor-pointer hover:bg-red-200 bg-gray-500 
  rounded-lg flex flex-col items-center'>
    ...
    <p className='text-base text-headingColor font-semibold my-2'>
        ...
        <span className='block text-sm text-gray-800 my-1'>
