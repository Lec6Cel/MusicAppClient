...
const FilterButtons = ({filterData, flag}) => {
  ...
  return (
    ...
    hover:border-gray-400'>
      <p className='text-base tracking-wide text-black flex items-center gap-2
      ...
      scrollbar-thin scrollbar-track-gray-200 scrollbar-thumb-gray-400 py-2 flex flex-col rounded-md 
